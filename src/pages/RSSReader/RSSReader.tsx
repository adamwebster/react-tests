...
const RSSReader = () => {
    ...
    const [feedUrl, setFeed] = useState(
    ...
    const FeedData = async () => {
        ...
        const feedItems = await Axios.get(corsUrl + feedUrl, {}).then(
            (response) => {
    ...
    const setRead = (guid: string) => {
        ...
        const isAdded = toSetJ.filter(
            (itemToCheck: any) => itemToCheck === guid
        );
        ...
        <>
            <RSSContext.Provider value={{ state, dispatch }}>
                <Wrapper>
                    ...
                    <Helmet>
                        <title>
                            RSS Reader | React Examples | Adam Webster
                        </title>
                    </Helmet>
                    <MobileMenuStyled theme={theme?.theme}>
                        <ToastProvider>
                            <RSSMenu
                                ...
                                setFeedIcon={(feedIcon: string) =>
                                    setFeedIcon(feedIcon)
                                }
                            />
                        </ToastProvider>
                    </MobileMenuStyled>
